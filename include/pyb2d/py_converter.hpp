...
template <> struct type_caster<b2Vec2> {
  ...
  // C++ -> Python
  static nb::handle from_cpp(const b2Vec2 &src, rv_policy policy,
                             cleanup_list *) {
...
template <> struct type_caster<b2BodyId> {
  ...
  // C++ -> Python (to int)
  static nb::handle from_cpp(const b2BodyId &src, rv_policy policy,
                             cleanup_list *) {
...
// shape id
template <> struct type_caster<b2ShapeId> {
  ...
  // C++ -> Python (to int)
  static nb::handle from_cpp(const b2ShapeId &src, rv_policy policy,
                             cleanup_list *) {
...
// ChainId
template <> struct type_caster<b2ChainId> {
  ...
  // C++ -> Python (to int)
  static nb::handle from_cpp(const b2ChainId &src, rv_policy policy,
                             cleanup_list *) {
...
// joint id
template <> struct type_caster<b2JointId> {
  ...
  // C++ -> Python (to int)
  static nb::handle from_cpp(const b2JointId &src, rv_policy policy,
                             cleanup_list *) {
...
template <> struct type_caster<b2WorldId> {
  ...
  // C++ -> Python (to int)
  static nb::handle from_cpp(const b2WorldId &src, rv_policy policy,
                             cleanup_list *) {
    return nb::cast((uint32_t)(src.index1 << 16) | (uint32_t)(src.revision))
        .release();
  }
};
