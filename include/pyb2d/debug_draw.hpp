...
namespace pyb2d
{
    ...
    // // *CollectingDebugDraw* is a DebugDraw that collects the data that would be drawn
    // // by the *DebugDraw* methods. This is useful when drawing in languages like Python.
    ...
    // // Furthermore this can be used to already round floats to screen pixel integers.
    // template<class TRANSFORM>
    // class CollectingDebugDraw : public DebugDraw<CollectingDebugDraw<TRANSFORM>>
    // {
    //     public:
