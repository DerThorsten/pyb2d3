...
namespace pyb2d
{
    ...
    struct GLSolidCapsules
    {
        ...
        void AddCapsule(b2Vec2 p1, b2Vec2 p2, float radius, b2HexColor c)
        {
            ...
            m_capsules.push_back(
                {{transform.p.x, transform.p.y, transform.q.c, transform.q.s}, radius, length, rgba}
            );
        }
    ...
    struct GLSolidPolygons
    {
        ...
        void
        AddPolygon(const b2Transform& transform, const b2Vec2* points, int count, float radius, b2HexColor color)
        {
            PolygonData data = {};
    ...
    void
    Draw::DrawSolidPolygon(b2Transform transform, const b2Vec2* vertices, int vertexCount, float radius, b2HexColor color)
    {
