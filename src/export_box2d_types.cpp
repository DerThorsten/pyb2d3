...
#define EXPORT_USER_DATA(T)                                                    \
  .def_prop_rw(                                                                \
      "user_data", [](T *t) { return user_data_uint(t->userData); },           \
...
void export_world_def(py::module_ &m) {
  ...
  py::class_<b2WorldDef>(m, "WorldDef")
      ...
      .def("__init__",
           [](b2WorldDef *t) { new (t) b2WorldDef(b2DefaultWorldDef()); })
...
void export_body_def(py::module_ &m) {
  ...
  py::class_<b2BodyDef>(m, "BodyDef")
      .def("__init__",
           [](b2BodyDef *t) { new (t) b2BodyDef(b2DefaultBodyDef()); })
...
void export_shape_def(py::module_ &m) {
  py::class_<b2ShapeDef>(m, "ShapeDef")
      .def("__init__",
           [](b2ShapeDef *t) { new (t) b2ShapeDef(b2DefaultShapeDef()); })
...
void export_chain_def(py::module_ &m) {
  py::class_<b2ChainDef>(m, "ChainDef")
      .def("__init__",
           [](b2ChainDef *t) { new (t) b2ChainDef(b2DefaultChainDef()); })
