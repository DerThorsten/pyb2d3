...
void export_world_functions(nb::module_ & m)
{
    ...
    m.def("world_overlap_aabb", &b2World_OverlapAABB,nb::arg("world_id"),nb::arg("aabb"),nb::arg("filter"),nb::arg("fcn"),nb::arg("context"));
    m.def("world_overlap_point", &b2World_OverlapPoint,nb::arg("world_id"),nb::arg("point"),nb::arg("transform"),nb::arg("filter"),nb::arg("fcn"),nb::arg("context"));
    m.def("world_overlap_circle", &b2World_OverlapCircle,nb::arg("world_id"),nb::arg("circle"),nb::arg("transform"),nb::arg("filter"),nb::arg("fcn"),nb::arg("context"));
    m.def("world_overlap_capsule", &b2World_OverlapCapsule,nb::arg("world_id"),nb::arg("capsule"),nb::arg("transform"),nb::arg("filter"),nb::arg("fcn"),nb::arg("context"));
    m.def("world_cast_ray", &b2World_CastRay,nb::arg("world_id"),nb::arg("origin"),nb::arg("translation"),nb::arg("filter"),nb::arg("fcn"),nb::arg("context"));
    m.def("world_cast_ray_closest", &b2World_CastRayClosest,nb::arg("world_id"),nb::arg("origin"),nb::arg("translation"),nb::arg("filter"));
    m.def("world_cast_circle", &b2World_CastCircle,nb::arg("world_id"),nb::arg("circle"),nb::arg("origin_transform"),nb::arg("translation"),nb::arg("filter"),nb::arg("fcn"),nb::arg("context"));
    m.def("world_cast_capsule", &b2World_CastCapsule,nb::arg("world_id"),nb::arg("capsule"),nb::arg("origin_transform"),nb::arg("translation"),nb::arg("filter"),nb::arg("fcn"),nb::arg("context"));
    m.def("world_cast_polygon", &b2World_CastPolygon,nb::arg("world_id"),nb::arg("polygon"),nb::arg("origin_transform"),nb::arg("translation"),nb::arg("filter"),nb::arg("fcn"),nb::arg("context"));
    ...
    m.def("world_set_restitution_threshold", &b2World_SetRestitutionThreshold,nb::arg("world_id"),nb::arg("value"));
    ...
    // m.def("world_set_custom_filter_callback", &b2World_SetCustomFilterCallback,nb::arg("world_id"),nb::arg("fcn"),nb::arg("context"));
    // m.def("world_set_pre_solve_callback", &b2World_SetPreSolveCallback,nb::arg("world_id"),nb::arg("fcn"),nb::arg("context"));
...
void export_body_functions(nb::module_ & m)
{
    ...
    m.def("body_apply_force", &b2Body_ApplyForce,nb::arg("body_id"),nb::arg("force"),nb::arg("point"),nb::arg("wake"));
    m.def("body_apply_force_to_center", &b2Body_ApplyForceToCenter,nb::arg("body_id"),nb::arg("force"),nb::arg("wake"));
    m.def("body_apply_torque", &b2Body_ApplyTorque,nb::arg("body_id"),nb::arg("torque"),nb::arg("wake"));
    m.def("body_apply_linear_impulse", &b2Body_ApplyLinearImpulse,nb::arg("body_id"),nb::arg("impulse"),nb::arg("point"),nb::arg("wake"));
    m.def("body_apply_linear_impulse_to_center", &b2Body_ApplyLinearImpulseToCenter,nb::arg("body_id"),nb::arg("impulse"),nb::arg("wake"));
    m.def("body_apply_angular_impulse", &b2Body_ApplyAngularImpulse,nb::arg("body_id"),nb::arg("impulse"),nb::arg("wake"));
...
void export_chain_functions(nb::module_ & m){
    ...
    m.def("chain_get_segments", &b2Chain_GetSegments,nb::arg("chain_id"),nb::arg("segment_array"),nb::arg("capacity"));
...
void export_distance_joint_functions(nb::module_ & m){
    ...
    m.def("distance_joint_enable_spring", &b2DistanceJoint_EnableSpring,nb::arg("joint_id"),nb::arg("enable_spring"));
    ...
    m.def("distance_joint_set_spring_damping_ratio", &b2DistanceJoint_SetSpringDampingRatio,nb::arg("joint_id"),nb::arg("damping_ratio"));
    ...
    m.def("distance_joint_set_length_range", &b2DistanceJoint_SetLengthRange,nb::arg("joint_id"),nb::arg("min_length"),nb::arg("max_length"));
    ...
    m.def("distance_joint_set_motor_speed", &b2DistanceJoint_SetMotorSpeed,nb::arg("joint_id"),nb::arg("motor_speed"));
    m.def("distance_joint_get_motor_speed", &b2DistanceJoint_GetMotorSpeed,nb::arg("joint_id"));
    m.def("distance_joint_set_max_motor_force", &b2DistanceJoint_SetMaxMotorForce,nb::arg("joint_id"),nb::arg("max_force"));
...
void export_motor_joint_functions(nb::module_ & m){
    ...
    m.def("motor_joint_set_linear_offset", &b2MotorJoint_SetLinearOffset,nb::arg("joint_id"),nb::arg("linear_offset"));
    m.def("motor_joint_get_linear_offset", &b2MotorJoint_GetLinearOffset,nb::arg("joint_id"));
    m.def("motor_joint_set_angular_offset", &b2MotorJoint_SetAngularOffset,nb::arg("joint_id"),nb::arg("angular_offset"));
    ...
    m.def("motor_joint_set_correction_factor", &b2MotorJoint_SetCorrectionFactor,nb::arg("joint_id"),nb::arg("correction_factor"));
...
void export_mouse_joint_functions(nb::module_ & m){
    ...
    m.def("mouse_joint_set_spring_damping_ratio", &b2MouseJoint_SetSpringDampingRatio,nb::arg("joint_id"),nb::arg("damping_ratio"));
...
void export_prismatic_joint_functions(nb::module_ & m){
    ...
    m.def("prismatic_joint_enable_spring", &b2PrismaticJoint_EnableSpring,nb::arg("joint_id"),nb::arg("enable_spring"));
    m.def("prismatic_joint_is_spring_enabled", &b2PrismaticJoint_IsSpringEnabled,nb::arg("joint_id"));
    m.def("prismatic_joint_set_spring_hertz", &b2PrismaticJoint_SetSpringHertz,nb::arg("joint_id"),nb::arg("hertz"));
    m.def("prismatic_joint_get_spring_hertz", &b2PrismaticJoint_GetSpringHertz,nb::arg("joint_id"));
    m.def("prismatic_joint_set_spring_damping_ratio", &b2PrismaticJoint_SetSpringDampingRatio,nb::arg("joint_id"),nb::arg("damping_ratio"));
    m.def("prismatic_joint_get_spring_damping_ratio", &b2PrismaticJoint_GetSpringDampingRatio,nb::arg("joint_id"));
    m.def("prismatic_joint_enable_limit", &b2PrismaticJoint_EnableLimit,nb::arg("joint_id"),nb::arg("enable_limit"));
    ...
    m.def("prismatic_joint_set_limits", &b2PrismaticJoint_SetLimits,nb::arg("joint_id"),nb::arg("lower"),nb::arg("upper"));
    m.def("prismatic_joint_enable_motor", &b2PrismaticJoint_EnableMotor,nb::arg("joint_id"),nb::arg("enable_motor"));
    m.def("prismatic_joint_is_motor_enabled", &b2PrismaticJoint_IsMotorEnabled,nb::arg("joint_id"));
    m.def("prismatic_joint_set_motor_speed", &b2PrismaticJoint_SetMotorSpeed,nb::arg("joint_id"),nb::arg("motor_speed"));
    ...
    m.def("prismatic_joint_set_max_motor_force", &b2PrismaticJoint_SetMaxMotorForce,nb::arg("joint_id"),nb::arg("force"));
...
void export_revolute_joint_functions(nb::module_ & m){
    ...
    m.def("revolute_joint_set_spring_damping_ratio", &b2RevoluteJoint_SetSpringDampingRatio,nb::arg("joint_id"),nb::arg("damping_ratio"));
    ...
    m.def("revolute_joint_set_limits", &b2RevoluteJoint_SetLimits,nb::arg("joint_id"),nb::arg("lower"),nb::arg("upper"));
    ...
    m.def("revolute_joint_set_motor_speed", &b2RevoluteJoint_SetMotorSpeed,nb::arg("joint_id"),nb::arg("motor_speed"));
    ...
    m.def("revolute_joint_set_max_motor_torque", &b2RevoluteJoint_SetMaxMotorTorque,nb::arg("joint_id"),nb::arg("torque"));
...
void export_weld_joint_functions(nb::module_ & m){
    ...
    m.def("weld_joint_set_reference_angle", &b2WeldJoint_SetReferenceAngle,nb::arg("joint_id"),nb::arg("angle_in_radians"));
    ...
    m.def("weld_joint_set_linear_damping_ratio", &b2WeldJoint_SetLinearDampingRatio,nb::arg("joint_id"),nb::arg("damping_ratio"));
    ...
    m.def("weld_joint_set_angular_damping_ratio", &b2WeldJoint_SetAngularDampingRatio,nb::arg("joint_id"),nb::arg("damping_ratio"));
...
void export_wheel_joint_functions(nb::module_ & m){
    ...
    m.def("wheel_joint_set_spring_damping_ratio", &b2WheelJoint_SetSpringDampingRatio,nb::arg("joint_id"),nb::arg("damping_ratio"));
    ...
    m.def("wheel_joint_set_max_motor_torque", &b2WheelJoint_SetMaxMotorTorque,nb::arg("joint_id"),nb::arg("torque"));
