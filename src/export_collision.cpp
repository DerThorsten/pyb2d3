...
void export_collision(py::module_ &m) {
  ...
  py::class_<b2ShapeCastInput>(m, "ShapeCastInput")
      ...
      .def_prop_rw(
          ...
          [](b2ShapeCastInput *self) {
            return ArrayVec2(reinterpret_cast<float *>(self->points),   // data
  ...
  py::class_<b2Polygon>(m, "Polygon")
      ...
      .def_prop_rw(
          "vertices",
          [](b2Polygon *self) {
            return ArrayVec2(reinterpret_cast<float *>(self->vertices), // data
                             {std::size_t(self->count), std::size_t(2)} // shape
            );
          },
      ...
      .def_prop_rw(
          "normals",
          [](b2Polygon *self) {
            return ArrayVec2(reinterpret_cast<float *>(self->normals),  // data
                             {std::size_t(self->count), std::size_t(2)} // shape
            );
          },
          [](b2Polygon *self, ArrayVec2 value) {
  ...
  m.def("make_offset_polygon", &b2MakeOffsetPolygon, py::arg("hull"),
        py::arg("position"), py::arg("rotation"));
  m.def("make_offset_rounded_polygon", &b2MakeOffsetRoundedPolygon,
        py::arg("hull"), py::arg("position"), py::arg("rotation"),
        py::arg("radius"));
  m.def("make_square", &b2MakeSquare, py::arg("h"));
  m.def("make_box", &b2MakeBox, py::arg("hx"), py::arg("hy"));
  m.def("make_rounded_box", &b2MakeRoundedBox, py::arg("hx"), py::arg("hy"),
        py::arg("radius"));
  m.def("make_offset_box", &b2MakeOffsetBox, py::arg("hx"), py::arg("hy"),
        py::arg("center"), py::arg("rotation"));
  m.def("make_offset_rounded_box", &b2MakeOffsetRoundedBox, py::arg("hx"),
        py::arg("hy"), py::arg("center"), py::arg("rotation"),
        py::arg("radius"));
  m.def("transform_polygon", &b2TransformPolygon, py::arg("transform"),
        py::arg("polygon"));
  m.def("compute_circle_mass", &b2ComputeCircleMass, py::arg("shape"),
        py::arg("density"));
  m.def("compute_capsule_mass", &b2ComputeCapsuleMass, py::arg("shape"),
        py::arg("density"));
  m.def("compute_polygon_mass", &b2ComputePolygonMass, py::arg("shape"),
        py::arg("density"));
  m.def("compute_circle_aabb", &b2ComputeCircleAABB, py::arg("shape"),
        py::arg("transform"));
  m.def("compute_capsule_aabb", &b2ComputeCapsuleAABB, py::arg("shape"),
        py::arg("transform"));
  m.def("compute_polygon_aabb", &b2ComputePolygonAABB, py::arg("shape"),
        py::arg("transform"));
  m.def("compute_segment_aabb", &b2ComputeSegmentAABB, py::arg("shape"),
        py::arg("transform"));
  m.def("point_in_circle", &b2PointInCircle, py::arg("point"),
        py::arg("shape"));
  m.def("point_in_capsule", &b2PointInCapsule, py::arg("point"),
        py::arg("shape"));
  m.def("point_in_polygon", &b2PointInPolygon, py::arg("point"),
        py::arg("shape"));
  m.def("ray_cast_circle", &b2RayCastCircle, py::arg("input"),
        py::arg("shape"));
  m.def("ray_cast_capsule", &b2RayCastCapsule, py::arg("input"),
        py::arg("shape"));
  m.def("ray_cast_segment", &b2RayCastSegment, py::arg("input"),
        py::arg("shape"), py::arg("one_sided"));
  m.def("ray_cast_polygon", &b2RayCastPolygon, py::arg("input"),
        py::arg("shape"));
  m.def("shape_cast_circle", &b2ShapeCastCircle, py::arg("input"),
        py::arg("shape"));
  m.def("shape_cast_capsule", &b2ShapeCastCapsule, py::arg("input"),
        py::arg("shape"));
  m.def("shape_cast_segment", &b2ShapeCastSegment, py::arg("input"),
        py::arg("shape"));
  m.def("shape_cast_polygon", &b2ShapeCastPolygon, py::arg("input"),
        py::arg("shape"));
  ...
  py::class_<b2Hull>(m, "Hull")
      ...
      .def_prop_rw(
          "points",
          [](b2Hull *self) {
            return ArrayVec2(reinterpret_cast<float *>(self->points));
          },
  ...
  m.def(
      "compute_hull",
      [](ArrayVec2 points) {
        b2Hull hull = b2ComputeHull(reinterpret_cast<b2Vec2 *>(points.data()),
                                    points.shape(0));
        return hull;
      },
      py::arg("points"));
  ...
  // b2SegmentDistance
  m.def("segment_distance", &b2SegmentDistance, py::arg("p1"), py::arg("q1"),
        py::arg("p2"), py::arg("q2"));
  ...
  // b2ShapeDistance
  m.def("shape_distance", &b2ShapeDistance, py::arg("cache"), py::arg("input"),
        py::arg("simplexes"), py::arg("simplexCapacity"));
  ...
  m.def(
      ...
      [](ArrayVec2 vertices, float radius) {
        return b2MakeProxy(reinterpret_cast<b2Vec2 *>(vertices.data()),
                           vertices.shape(0), radius);
      },
      py::arg("vertices"), py::arg("radius"));
  ...
  // b2GetSweepTransform
  m.def("get_sweep_transform", &b2GetSweepTransform, py::arg("sweep"),
        py::arg("time"));
